...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    <img src="/images/what.jpeg" class="card-img-top" alt="Foto Lulusan 1">
                    <div class="card-body">
                        <h5 class="card-title">Nuranisa</h5>
                        <p class="card-text">Lulusan tahun 2021 dengan ipk 3.80</p>
            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    <img src="/images/whatt.jpeg" class="card-img-top" alt="Foto Lulusan 2">
                    <div class="card-body">
                        <h5 class="card-title">Indah prasetyani</h5>
                        <p class="card-text">Lulusan tahun 2021 dengan ipk 3.54</p>
                        <a href="#" class="btn btn-primary">Selengkapnya</a>
                    </div>
                </div>
            </div>
